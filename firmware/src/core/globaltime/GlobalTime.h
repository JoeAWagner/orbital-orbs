...
public:
    ...
    // Force the timezone offset to be re-fetched from the API on the next
    // updateTime() (used after the timezone is changed from the web panel).
    void forceTimezoneUpdate();

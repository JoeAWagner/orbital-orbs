...
#define WEATHER_LOCATION "Shoreham, NY" // City/state for the weather, look it up on https://www.visualcrossing.com/weather-data
...
#define STOCK_TICKER_LIST "BTC/USD,AAPL,TSLA,MSFT,GOOG" // Choose 5 securities to track. You can track forex, crypto (symbol/USD) or stocks from any exchange (if one ticker is part of multiple exchanges you can add on "&country=Canada" to narrow down to your ticker)
...
#define BUSY_PIN 21 // Was 2, but GPIO2 is BUTTON_LEFT on Orbital hardware; moved to an unused GPIO
